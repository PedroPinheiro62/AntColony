...
class Civilisation(Tk):
    def __init__(self): #Constructeur de la classe FenPrincipale
        ...
        self.__vB = Ville('B',250,400,[],'int',self.__zoneAffichage)
        self.__vC = Ville('C',400,300,[],'int',self.__zoneAffichage)
        self.__vD = Ville('D',400,600,[],'int',self.__zoneAffichage)
        self.__vE = Ville('E',550,400,[],'int',self.__zoneAffichage)
        self.__vF = Ville('F',700,400,[],'food',self.__zoneAffichage)
        self.__vG = Ville('G',700,200,[],'int',self.__zoneAffichage)
        self.__vH = Ville('H',100,200,[],'int',self.__zoneAffichage)       
        
        #Création des routes.
        self.__routes.append(Route([self.__vA,self.__vB],self.__zoneAffichage))
        self.__routes.append(Route([self.__vB,self.__vC],self.__zoneAffichage))
        ...
        self.__routes.append(Route([self.__vE,self.__vF],self.__zoneAffichage))
        self.__routes.append(Route([self.__vA,self.__vH],self.__zoneAffichage))
        self.__routes.append(Route([self.__vH,self.__vG],self.__zoneAffichage))
