...
class Civilisation(Tk):
    def __init__(self): #Constructeur de la classe FenPrincipale
        ...
        self.__vA = Ville('A',50,50,[],'nid',self.__zoneAffichage)
        self.__vB = Ville('B',50,200,[],'int',self.__zoneAffichage)
        self.__vC = Ville('C',150,50,[],'int',self.__zoneAffichage)
        self.__vD = Ville('D',200,200,[],'int',self.__zoneAffichage)
        self.__vE = Ville('E',300,100,[],'int',self.__zoneAffichage)
        self.__vF = Ville('F',300,300,[],'int',self.__zoneAffichage)
        self.__vG = Ville('G',400,200,[],'int',self.__zoneAffichage)
        self.__vH = Ville('H',100,300,[],'int',self.__zoneAffichage)
        self.__vI = Ville('I',450,50,[],'int',self.__zoneAffichage)
        self.__vJ = Ville('J',50,400,[],'int',self.__zoneAffichage)
        self.__vK = Ville('K',100,500,[],'int',self.__zoneAffichage)
        self.__vL = Ville('L',500,300,[],'int',self.__zoneAffichage)
        self.__vM = Ville('M',200,450,[],'int',self.__zoneAffichage)
        self.__vN = Ville('N',600,450,[],'int',self.__zoneAffichage)
        self.__vO = Ville('O',475,500,[],'int',self.__zoneAffichage)
        self.__vP = Ville('P',550,600,[],'int',self.__zoneAffichage)
        self.__vQ = Ville('Q',700,700,[],'food',self.__zoneAffichage)
        self.__vR = Ville('R',300,600,[],'int',self.__zoneAffichage)
        self.__vS = Ville('S',400,400,[],'int',self.__zoneAffichage)
        self.__vT = Ville('T',100,750,[],'int',self.__zoneAffichage)
        self.__vU = Ville('U',150,650,[],'int',self.__zoneAffichage)
        self.__vV = Ville('V',400,700,[],'int',self.__zoneAffichage)
        self.__vX = Ville('X',750,400,[],'int',self.__zoneAffichage)
        self.__vW = Ville('W',650,200,[],'int',self.__zoneAffichage)
        self.__vY = Ville('Y',700,100,[],'int',self.__zoneAffichage)
        self.__vZ = Ville('Z',650,550,[],'int',self.__zoneAffichage)
        ...
        self.__routes.append(Route([self.__vA,self.__vD],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vB,self.__vD],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vB,self.__vH],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vB,self.__vJ],self.__zoneAffichage))  
        ...
        self.__routes.append(Route([self.__vC,self.__vI],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vD,self.__vH],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vD,self.__vE],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vD,self.__vF],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vD,self.__vG],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vE,self.__vI],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vE,self.__vG],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vF,self.__vM],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vF,self.__vR],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vF,self.__vS],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vG,self.__vL],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vG,self.__vF],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vH,self.__vF],self.__zoneAffichage)) 
        self.__routes.append(Route([self.__vH,self.__vM],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vI,self.__vG],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vI,self.__vL],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vI,self.__vW],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vI,self.__vY],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vJ,self.__vK],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vJ,self.__vM],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vJ,self.__vH],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vK,self.__vU],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vK,self.__vT],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vK,self.__vR],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vL,self.__vS],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vL,self.__vN],self.__zoneAffichage)) 
        self.__routes.append(Route([self.__vM,self.__vK],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vM,self.__vR],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vN,self.__vZ],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vO,self.__vN],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vO,self.__vP],self.__zoneAffichage)) 
        self.__routes.append(Route([self.__vQ,self.__vP],self.__zoneAffichage)) 
        self.__routes.append(Route([self.__vQ,self.__vZ],self.__zoneAffichage))
        self.__routes.append(Route([self.__vR,self.__vP],self.__zoneAffichage))
        self.__routes.append(Route([self.__vR,self.__vO],self.__zoneAffichage)) 
        self.__routes.append(Route([self.__vS,self.__vR],self.__zoneAffichage)) 
        self.__routes.append(Route([self.__vS,self.__vO],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vS,self.__vN],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vT,self.__vU],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vT,self.__vV],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vU,self.__vR],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vU,self.__vV],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vV,self.__vP],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vV,self.__vQ],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vX,self.__vZ],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vX,self.__vN],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vX,self.__vQ],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vW,self.__vL],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vW,self.__vX],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vW,self.__vN],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vY,self.__vW],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vY,self.__vX],self.__zoneAffichage))  
        self.__routes.append(Route([self.__vZ,self.__vP],self.__zoneAffichage))  
